...
public final class AsyncTaskStreamConstants {
    ...
    /**
     * 当前消息进入 Stream 的时间戳，用于计算队列等待时间。
     */
    public static final String FIELD_ENQUEUED_AT = "enqueuedAtEpochMs";

    /**
     * 从死信流重放时记录原死信ID，便于审计和幂等排查。
     */
    public static final String FIELD_REPLAYED_FROM = "replayedFrom";
    ...
    public static final String DEAD_LETTER_STREAM_KEY = "async:task:dead-letter:stream";

    public static final String DEAD_LETTER_INDEX_KEY = "async:task:dead-letter:index";

    public static final String DEAD_LETTER_REPLAY_LOCK_PREFIX = "async:task:dead-letter:replay:";

    public static final int DEAD_LETTER_STREAM_MAX_LEN = 5000;
